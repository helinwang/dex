...
func (_m *Peer) GetData(requester string, items []consensus.ItemID) error {
	ret := _m.Called(requester, items)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, []consensus.ItemID) error); ok {
...
func (_m *Peer) Inventory(sender string, items []consensus.ItemID) error {
